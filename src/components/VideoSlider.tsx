...
/**
 * Video playback slider with progress and buffering indicators
 * @group Components
 */
export const VideoSlider: (
  ...
  ({ media, value: providedValue, onValueChange, ...props }, ref) => {
    ...
    useFrame(() => {
      if (!mountedRef.current || !media || !media.duration) return
    ...
    const handler = useMemo(() => {
      ...
      return {
        ...
        onPointerUp(e) {
          ...
          ;(e.target as HTMLElement).releasePointerCapture(downPointerId)
